...
class UserAdmin(BaseUserAdmin):
    ...
    'institution','faculty','department','set',
    'rating','is_institution_admin','is_faculty_admin',
    'is_department_admin','is_set_admin','associations',
    'association_admin','grouped_events','single_events',
    'is_active')}),
