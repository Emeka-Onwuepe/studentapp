...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    associations = models.ManyToManyField(Association,related_name="user_associations",blank=True, null=True)
    association_admin = models.ManyToManyField(Association,related_name="association_admin",blank=True, null=True)
    grouped_events = models.ManyToManyField(Grouped_Events,related_name="user_grouped_events",blank=True, null=True)
    single_events = models.ManyToManyField(Single_Event,related_name="user_single_events",blank=True, null=True)
